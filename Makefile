...
#    Updated: 2024/05/19 12:31:24 by bebrandt         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAIN_SRCS			+=	$(addprefix $(MAIN_DIR), $(addsuffix .c, prompt verbose))
...
PARSER_SRCS			=	$(addprefix $(PARSER_DIR), $(addsuffix .c, parser parser_check_redirections parser_check_cmd))
